...
import { AlertTriangle, Shield, Activity, Terminal, Network, HardDrive, Settings, CheckCircle, Send, Clock, Eye } from 'lucide-react';
...
export default function EDRDashboard() {
  ...
  const handleTriage = (alertId: string, action: string) => {
    ...
    if (action === 'escalated' && siemEndpoint) {
      ...
      }).catch(err => console.log('SIEM endpoint not available yet'));
    }
  };
        ...
        {showSettings && (
          <div className="mt-4 p-4 bg-gray-800 rounded-lg border border-gray-700">
            ...
            <div className="flex gap-2">
              <input
                type="text"
                placeholder="Enter SIEM Webhook URL (e.g., https://your-siem.vercel.app/api/alerts)"
                value={siemEndpoint}
